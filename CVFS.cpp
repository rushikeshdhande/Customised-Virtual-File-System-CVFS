...
void InitialiseUAREA()
{
   ...
   for(i = 0; i < MAXOPENFILES; i++)
   {
    ...
    printf("Rushikesh CVFS : UAREA gets initialised succesfully\n");
}
...
void InitialiseSuperBlock()
{
    ...
    printf("Rushikesh CVFS : Super block gets initialised succesfully\n");
}
...
void CreateDILB()
{
    ...
    printf("Rushikesh CVFS : DILB created succesfully\n");
}
...
void StartAuxillaryDataInitilisation()
{
    ...
    printf("Rushikesh CVFS : Auxillary data initialised succesfully\n");
}
...
void LsFile()
{
    ...
    printf("-----------------------------------------------\n");
    printf("------ Rushikesh CVFS Files Information ------\n");
    printf("-----------------------------------------------\n");
...
int main()
{
    ...
    printf("-----------------------------------------------\n");
    printf("----- Rushikesh CVFS started succesfully -----\n");
    printf("-----------------------------------------------\n");
    ...
    while(1)
    {
        ...
        if(iCount == 1)
        {
            ...
            {
                printf("Thank you for using Rushikesh CVFS\n");
